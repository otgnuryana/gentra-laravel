...
<main>
    ...
    <section class="section-popular-content" id="popularContent">
        <div class="container">
            <div class="row section-popular-travels justify-content-center">
        ...
        <div class="container">
            <div class="section-popular-travel row justify-content-center">
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="frontend/images/Mask Group 3.png" alt="User" class="mb-4 mt-5 rounded-circle">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="frontend/images/Shayna.png" alt="User" class="mb-4 mt-5 rounded-circle">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="frontend/images/Shabrina.png" alt="User" class="mb-4 mt-5 rounded-circle">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <a href="#" class="btn btn-help px-4 mt-5 mx-1">
                        I Need Help
                    </a>
                    <a href="{{ route('register')}}" class="btn btn-get-started px-4 mt-5 mx-1">
                        Get Started
                    </a>
                </div>
            </div>
